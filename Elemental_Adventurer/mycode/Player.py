...
class Player(Sprite):
    def __init__(self, start_x, start_y):
        ...
        new_path = r"image"
        os.chdir(new_path)
        super().__init__("player.png", start_x, start_y)
        ...
        self.attack.image = pygame.image.load("attack.png")
    ...
    def update(self, boxes):
        ...
        from mycode.velue import enemys
        if enemys:
    ...
    def draw(self, screen):
        ...
        if self.attack_visible:
            screen.blit(self.attack.image, self.attack.rect)
...
class EvolvingPlayer(Player):
    ...
    def update(self, boxes):
        ...
        from mycode.velue import lava_boxes, water_boxes
